...
namespace AltoLib
{
    public class FavoritesWindow : EditorWindow
    {
        ...
        {
            GetWindow<FavoritesWindow>("Åö Favorites");
        }
        ...
        void OnGUI()
        {
            ...
            {
                var content = new GUIContent("Åö Fav", "Bookmark selected asset");
                ...
                {
                    if (GUILayout.Button("Å• Sort by Type", GUILayout.MaxWidth(200)))
                    {
                        SortByType();
                    }
                    if (GUILayout.Button("Å• Sort by Name", GUILayout.MaxWidth(200)))
                    {
                        SortByName();
                    }
                }
        ...
        bool DrawAssetRow(AssetInfo info)
        {
            ...
            {
                var content = new GUIContent(" Åù ", "Highlight asset");
